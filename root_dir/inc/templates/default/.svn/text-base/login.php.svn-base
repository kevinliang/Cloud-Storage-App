...
<html>
	<head>
		...
		<link type="text/css" href="src/css/theme/ui-lightness/jquery-ui-1.8.14.custom.css<?php echo $v;?>" rel="stylesheet" />
		<link rel="stylesheet" type="text/css" href="src/css/lite.css<?php echo $v;?>">
		...
		<script type="text/javascript" src="src/js/password.js<?php echo $v;?>"></script>
		<script type="text/javascript" src="src/js/login.js<?php echo $v;?>"></script>
	</head>
	<body>
		<div id="page">
			<div id="complete">
